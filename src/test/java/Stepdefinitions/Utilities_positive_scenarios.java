...
public class Utilities_positive_scenarios extends Generic_functions {
	...
	public static void utilities_positive_tc_004() throws Exception {
		try {
			...
			page_wait(1000);
			driver.findElement(By.xpath(OR_reader( "utilities_card_number"))).sendKeys(td_reader("utilities_card_number"));
			page_wait(1000);
			driver.findElement(By.xpath(OR_reader( "utilities_card_expiry"))).sendKeys(td_reader("utilities_card_expiry"));
			page_wait(1000);
			driver.findElement(By.xpath(OR_reader("utilities_card_cvc"))).sendKeys(td_reader("utilities_card_cvc"));
			page_wait(1000);
			driver.findElement(By.xpath(OR_reader("utilities_card_post"))).sendKeys(td_reader("utilities_card_post"));
			page_wait(1000);
			driver.findElement(By.xpath(OR_reader("utilities_card_phoneno"))).sendKeys(td_reader("utilities_card_phoneno"));
			...
			if((platformName.equals("Android"))){				
				...
				click("utilities_card_state");
				driver.findElement(By.className("XCUIElementTypePickerWheel")).sendKeys(td_reader("utilities_card_state"));
				page_wait(1000);
				click("dropdown_done");
			}
			page_wait(3000);
			driver.findElement(By.xpath(OR_reader("utilities_card_city"))).sendKeys(td_reader("utilities_card_city"));
		}catch (Exception e) {
			e.printStackTrace();
	...
	public void bank_details() throws Exception {
		try {	
			...
			driver.findElement(By.xpath(OR_reader("utilities_bank_name"))).sendKeys(td_reader("utilities_bank_name"));
			page_wait(1000);
			driver.findElement(By.xpath(OR_reader("utilities_bank_routingno"))).sendKeys(td_reader("utilities_bank_routingno"));
			page_wait(2000);
			...
			if((platformName.equals("Android"))){				
				...
				click("utilities_bank_holdertype");
				driver.findElement(By.className("XCUIElementTypePickerWheel")).sendKeys(td_reader("utilities_bank_holdertype"));
				page_wait(1000);
				click("dropdown_done");
			}			
			driver.findElement(By.xpath(OR_reader("utilities_bank_accountno"))).sendKeys(td_reader("utilities_bank_accountno"));
			page_wait(1000);
